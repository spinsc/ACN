        ...
        <div style={{ flex:1, overflowY:'auto', padding:'14px 18px' }}>
          ...
          {isOP && (
            <>
              ...
              {ehVendaEnvio ? (
                <div style={{ marginBottom:8, fontSize:9, color:'#0369a1' }}>
                  🚦 Fluxo de entrega: <strong>Envio de material</strong> (automático em Venda para Envio)
                </div>
              ) : (
